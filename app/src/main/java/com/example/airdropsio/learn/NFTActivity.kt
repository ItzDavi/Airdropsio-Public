...
class NFTActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val rootLayout = findViewById<ScrollView>(R.id.NFT_scroll_view)
        rootLayout.setOnTouchListener(object : OnSwipeTouchListener(this@NFTActivity) {
            override fun onSwipeRight() {
                ...
                val intent = Intent(this@NFTActivity, LearnActivity::class.java)
                startActivity(intent)
                overridePendingTransition(R.anim.slide_in_right, R.anim.slide_out_right)
                finish()
            }
