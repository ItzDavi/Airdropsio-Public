...
class IGOActivity : AppCompatActivity() {
    @SuppressLint("ClickableViewAccessibility")
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_igoactivity)
        ...
        val rootLayout = findViewById<ScrollView>(R.id.IGO_scroll_view)
        rootLayout.setOnTouchListener(object : OnSwipeTouchListener(this@IGOActivity) {
            override fun onSwipeRight() {
                ...
                val intent = Intent(this@IGOActivity, LearnActivity::class.java)
                startActivity(intent)
                overridePendingTransition(R.anim.slide_in_right, R.anim.slide_out_right)
                finish()
            }
